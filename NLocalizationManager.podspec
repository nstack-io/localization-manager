#
#  Be sure to run `pod spec lint TranslationManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Nodes - iOS"
  # spec.authors            = { "Nodes - iOS" => "tech@nodes.dk" }
  # spec.social_media_url   = "https://twitter.com/Nodes - iOS"
  ...
  spec.source_files  = "LocalizationManager/Classes/**/*.swift"
  #spec.exclude_files = "Classes/Exclude"
  #spec.public_header_files = "LocalizationManager/Supporting Files/*.h"
