...
Pod::Spec.new do |spec|
  ...
  A manager that handles persisted and on-the-fly translations in your app.
                   DESC

  spec.homepage     = "https://github.com/nodes-ios/TranslationManager"
  ...
  spec.test_spec 'TranslationManagerTests' do |test_spec|
    test_spec.source_files = "TranslationManagerTests"
  end
